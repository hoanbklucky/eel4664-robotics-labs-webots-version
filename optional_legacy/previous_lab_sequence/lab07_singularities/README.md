> **Archived:** This README belongs to the former 13-lab sequence and is not assigned. Its useful source moved to the [active consolidated lab](../../../lab03_jacobian_singularities/README.md). Paths and numbering below are retained for historical context.
