> **Archived:** This README belongs to the former 13-lab sequence and is not assigned. Its useful source moved to the [active consolidated lab](../../../lab06_integrated_manipulation/README.md). Paths and numbering below are retained for historical context.
